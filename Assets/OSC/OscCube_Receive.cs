...
public class OscCube_Receive : MonoBehaviour
{
    UnityEngine.Object sync = new UnityEngine.Object();

    [SerializeField] int port_ObjectPos = 1;
    ...
    void OnEnable()
    {
        ...
        server_ObjectPos.MessageDispatcher.AddCallback(
            ...
            (string address, OscDataHandle data) => {
                ...
                {
					//受信したZ座標をX座標に適応させる
                    ObjectPos.x = data.GetElementAsFloat(0); // X座標の受信
                    ObjectPos.y = data.GetElementAsFloat(1); // Y座標の受信
                    ObjectPos.z = data.GetElementAsFloat(2); // Z座標の受信
                }
            }
        );
    }
    ...
    void Update()
    {
		...
		Vector3 newPosition = new Vector3(ObjectPos.z, ObjectPos.y, ObjectPos.x);
